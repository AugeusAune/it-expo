...
<head>
    ...
    <style>
        * {
        ...
        .navbar1 .nav-item1 .nav-link1 .active {
                    ...
                    <?= $this->session->flashdata('message'); ?>
                        ...
                        <?php foreach($komen as $k) : ?>
                            <tr>
                                ...
                                <td><?= $k['pesan']; ?></td>
                                <td>
                                <a href="<?= base_url('admin/hapuskomen/' . $k['id']); ?>" onclick="return confirm('are you sure ?')"class="btn btn-danger"><i class="fas fa-trash"></i> </a>    
                                </td>
                            </tr>
                        <?php endforeach; ?>
                        </tbody>
