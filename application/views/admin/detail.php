...
<body>
    ...
    <main>
        <div class="container mt-5">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card mb-3" style="max-width: 1800px; min-width: 900px; min-height: 250px; max-height: 9000rem">
                        <div class="row no-gutters">
                            <div class="col-md-4">
                            <img src="<?= base_url('./assets/img/' . $detail['gambar']); ?>" class="card-img" alt="...">
                            </div>
                            <div class="col-md-8">
                            <div class="card-body">
                                <h2 class="card-title"><?= $detail['nama_cagar'] ?></h2>
                                <h6>Provinsi : <?= $detail['provinsi'] ?></h6>
                                <h6>Kategori : <?= $detail['kategori'] ?></h6>
                                <h6>Lokasi   : <?= $detail['lokasi'] ?></h6>
