...
<body>
    ...
    <main>
        <div class="container mt-5">
            <h1 class="mb-3">Add Data Cagar</h1>
            <div class="row">
                <div class="col-xl-6">
                    <form class="user" method="post" action="<?= base_url('admin/adddata'); ?>" enctype="multipart/form-data">
                        <?= $this->session->flashdata('message'); ?>
                        <div class="form-group row">
                            <label for="nama_cagar" class="col-sm-2 col-form-label">Nama Cagar</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="nama_cagar" name="nama_cagar">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select name="kategori" id="kategori" class="form-control">
                                    ...
                                    <option value="kawasan">Tarian</option>
                                    <option value="struktur">Alat Musik</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" name="deskripsi" id="deskripsi" style="min-height: 200px; max-height:1000rem"></textarea>
